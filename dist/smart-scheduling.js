...
exports.testSmartScheduling = testSmartScheduling;
exports.testPriorityBasedScheduling = testPriorityBasedScheduling;
...
async function testSmartScheduling() {
    ...
    // @ts-ignore
    const taskInSchedule = schedule.find((item) => item.taskId === createdTask._id);
