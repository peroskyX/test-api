...
router.get('/demo', async (req, res) => {
    try {
        ...
        const noOptimalTimeNotification = await notificationService.sendNotification(notificationService_1.NotificationType.NO_OPTIMAL_TIME, userId, {
            taskId: 'task-123',
        ...
        const rescheduledNotification = await notificationService.sendNotification(notificationService_1.NotificationType.TASK_RESCHEDULED, userId, {
            taskId: 'task-456',
        ...
        const displacedNotification = await notificationService.sendNotification(notificationService_1.NotificationType.TASK_DISPLACED, userId, {
            taskId: 'task-789',
        ...
        const windDownNotification = await notificationService.sendNotification(notificationService_1.NotificationType.LATE_WIND_DOWN_CONFLICT, userId, {
            taskId: 'task-101',
            taskTitle: 'Workout Session'
        });
        notifications.push(windDownNotification);
        // 5. Deadline Approaching Notification
        const deadlineNotification = await notificationService.sendNotification(notificationService_1.NotificationType.TASK_DEADLINE_APPROACHING, userId, {
            taskId: 'task-202',
